...
$input[] = "    Minimum = 21ms, Maximum = 21ms, Mittelwert = 21ms";

$expect['min'] = 21;
$expect['avg'] = 21;
$expect['max'] = 21;
$expect['ttl'] = 246;
$expect['bytesperreq'] = 32; // explicitly stated in success packet lines
$expect['received'] = 3;
$expect['transmitted'] = 3;
$expect['loss'] = 0;
$expect['bytestotal'] = 96;
$expect['targetip'] = '209.85.129.147';
$expect['icmpseq'][1] = 21; // generated sequence numbers
$expect['icmpseq'][2] = 21;
$expect['icmpseq'][3] = 21;
